...
if($bn!=NULL && $au!=NULL)
{
    $sql=mysqli_query($set,"INSERT INTO books(name,author,id,rent) VALUES('$bn','$au','$ae','$br')");
    if($sql)
    {
...
<tr><td class="labels">Book ID : </td><td><input type="text" name="id" placeholder="Enter book id" size="25" class="fields" required="required"  /></td></tr>
<tr><td class="labels">Rent : </td><td><input type="number" name="rent" placeholder="Enter fee(pm)" size="25" class="fields" required="required"  /></td></tr>
